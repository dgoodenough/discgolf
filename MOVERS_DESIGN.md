...
- **D3 → day 1%, week 2%,** set from the measured distribution rather than
  ...
  1% floor sits ~2x above that p90 and admits ~13 MPO / ~9 FPO players per
  day-step, so the daily tab fills on active days and stays honestly sparse on
  quiet ones.
- **D2 (intra-day / round-to-round)** — still open, still out of scope.
